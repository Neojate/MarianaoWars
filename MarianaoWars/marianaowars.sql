...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-03-2020 a las 00:07:34
...
('9dea9977-a375-4be6-864d-e541e09dbafc', 'bydoser@gmail.com', 'BYDOSER@GMAIL.COM', 'bydoser@gmail.com', 'BYDOSER@GMAIL.COM', 1, 'AQAAAAEAACcQAAAAEN57mAMPfAu8hUZs8toP7KfGEhGxujYnKcBBsWkPi8i9oxqevlDfVTOEVcP5opyq9A==', 'JKC7GAYSGMESW2NEKAUPQH6PQTJ5KQ4V', 'fd99e591-ad5a-4199-b4a8-b145455bb6f2', NULL, 0, 0, NULL, 1, 0);
...
--
-- Estructura de tabla para la tabla `devicecodes`
--
...
--
-- Estructura de tabla para la tabla `persistedgrants`
--
...
('20200223183016_InitialCreate', '3.1.0');
...
--
-- Indices de la tabla `devicecodes`
--
...
--
-- Indices de la tabla `persistedgrants`
--
